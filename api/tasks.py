...
class Procressing:
    ...
    def task(self):
        ...
        while comments:
             ...
             sentiment_analysis_db.insert_one({"titles": titles, "comment": "".join(listed_cleaned_data), "main_result": sentiment_analysis_main_data, "other_result": sentiment_analysis_aditional_data})
        return "Done"
